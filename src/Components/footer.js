  ...
  return (
    <footer class="main-footer style-two">
                ...
                <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                  <div class="footer-widget logo-widget">
                    ...
                    <div class="text">
                      ...
                      Care About Medical Care Health Suspendisse metus turpis.
                    </div>
                ...
                <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                  <div class="footer-widget contact-widget">
                    ...
                    <ul class="contact-list">
                      <li>
                        <span class="icon flaticon-placeholder"></span>2130
                        Fulton Street San Diego, CA 94117-1080 USA
                      </li>
                      <li>
                        <span class="icon flaticon-placeholder"></span>Another
                        Address Goes Here, City, State, ZIP, Country
                      </li>
                      <li>
                        <span class="icon flaticon-placeholder"></span>Third
                        Address Goes Here, City, State, ZIP, Country
                      </li>
                    </ul>
                  </div>
      ...
      <div class="footer-bottom">
        <div class="auto-container">
          <div class="copyright">
            MediTech Helth Care &copy; All Rights Reserved By Expertthemes
          </div>
        </div>
      </div>
    </footer>
